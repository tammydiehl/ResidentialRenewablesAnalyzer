...
class CAESTech(Storage):
    ...
    def objective_function(self, variables, mask, annuity_scalar=1):
        ...
        fuel_exp = cvx.sum(cvx.multiply(self.fuel_price[mask].values, variables['dis']) * self.heat_rate_high * self.dt * 1e-6 * annuity_scalar)
    ...
    def timeseries_report(self):
        ...
        results['CAES SOC (%)'] = self.variables['ene'] / energy_rate
